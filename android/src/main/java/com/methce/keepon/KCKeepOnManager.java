...
public class KeepOnProximityManager {
    private static final String TAG = "KeepOnProximityManager";
    ...
    /** Construction */
    static KeepOnProximityManager create(Context context, final KeepOn keepOn) {
        return new KeepOnProximityManager(context, keepOn);
    }

    private KeepOnProximityManager(Context context, final KeepOn keepOn) {
        Log.d(TAG, "KeepOnProximityManager");
